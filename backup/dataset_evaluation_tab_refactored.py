...
# 导入拆分的组件模块
from ..src.ui.components.dataset_analyzers import ClassificationAnalyzer, DetectionAnalyzer
from ..src.ui.components.weight_generator import WeightGenerator
from ..src.ui.components.chart_manager import ChartManager
from ..src.ui.components.result_display_manager import ResultDisplayManager
